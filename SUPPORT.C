#pragma	title("DBCS Driver  --  Version 1  --  (Support.C)")
...
for ( i	= 1; i < cItems; i++ )
   ...
   WinCreateWindow(hWnd, pvClassName, pvText, pdlgt->adlgti[i].flStyle,	aptl[0].x, aptl[0].y, aptl[1].x, aptl[1].y,
		   hWnd, HWND_BOTTOM, (ULONG)(pdlgt->adlgti[i].id & 0xffff), pvCtlData,	pvPresParams);
   }
   ...
   case	WM_CHAR	:
	   ...
	   switch ( SHORT2FROMMP(mp2) )
		   ...
		   WinSetFocus(HWND_DESKTOP,
			       WinEnumDlgItem(hWnd, WinQueryFocus(HWND_DESKTOP), EDI_NEXTTABITEM));
		   break;
		   ...
		   WinSetFocus(HWND_DESKTOP,
			       WinEnumDlgItem(hWnd, WinQueryFocus(HWND_DESKTOP), EDI_NEXTGROUPITEM));
		   break;
		   ...
		   WinSetFocus(HWND_DESKTOP,
			       WinEnumDlgItem(hWnd, WinQueryFocus(HWND_DESKTOP), EDI_PREVTABITEM));
		   break;
		   ...
		   WinSetFocus(HWND_DESKTOP,
			       WinEnumDlgItem(hWnd, WinQueryFocus(HWND_DESKTOP), EDI_PREVGROUPITEM));
		   break;
	       }
       break;
